Todos os exercícios que fiz para as disciplinas 'Fundamentos de Banco de Dados' e 'Implementação de Banco de Dados', ambas realizadas no quarto semestre da faculdade de 'Sistemas de Informação', na UFSM.
